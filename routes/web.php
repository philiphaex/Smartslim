...
Route::post('clients/visits/items/store','ItemController@store');
Route::post('clients/visits/items/edit','ItemController@edit');
Route::post('clients/visits/items/delete','ItemController@destroy');
